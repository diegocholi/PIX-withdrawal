...
use Tecnofit\PixWithdrawal\Core\Application\UseCase\PublishDomainEvent;
...
final class UseCaseContractTest extends TestCase
{
    ...
    public function testPublishDomainEventContract(): void
    {
        $this->assertUseCaseSignature(
            PublishDomainEvent::class,
            PublishDomainEventCommand::class,
            PublishDomainEventOutput::class
        );
    }

    public function testPublishDomainEventCommandCarriesSerializablePayload(): void
    {
        $reflection = new ReflectionClass(PublishDomainEventCommand::class);

        self::assertTrue($reflection->hasMethod('eventName'));
        self::assertTrue($reflection->hasMethod('payload'));
        self::assertTrue($reflection->hasMethod('correlationId'));
        self::assertTrue($reflection->hasMethod('traceMetadata'));
        self::assertSame('array', (string) $reflection->getMethod('payload')->getReturnType());
    }
    ...
    public function testApplicationInputAndOutputContractsRemainInterfaces(): void
    {
        ...
        self::assertTrue((new ReflectionClass(PublishDomainEventCommand::class))->isInterface());
        ...
        self::assertTrue((new ReflectionClass(PublishDomainEventOutput::class))->isInterface());
        ...
        self::assertTrue((new ReflectionClass(PublishDomainEventCommand::class))->implementsInterface(Traceable::class));
        ...
        self::assertTrue((new ReflectionClass(PublishDomainEventOutput::class))->implementsInterface(Traceable::class));

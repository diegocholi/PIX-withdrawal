...
use Tecnofit\PixWithdrawal\Core\Infrastructure\Contract\ProcessableWithdrawQuery as ProcessableWithdrawQueryContract;
...
final readonly class ProcessableWithdrawQuery implements ProcessableWithdrawQueryContract
{
    ...
    public function lockById(string $withdrawId): ?ProcessableWithdraw
    {
        ...
        return new ProcessableWithdraw(
     ...
     */
    private function toWithdrawPix(array $row): ?AccountWithdrawPix
    {
